...
public class RealTimeFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            mParam2 = getArguments().getString(mRoom);
            room = getArguments().getParcelable(mRoom);
            Log.d("RealTime", mParam1);
            if (room!=null){
                Log.d("RoomId", mParam1);
                String roomID = room.getRoomId();
                Log.d("Frag Room Id", ""+roomID);
            }else {
                Log.d("MyTag", "Room Id Is Null");
            }
